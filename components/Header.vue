        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full lg:w-1/2 px-4 mb-12 lg:mb-0 flex items-center">
            <div class="w-full text-center lg:text-left">
              ...
              <div class="max-w-sm mx-auto lg:mx-0">
                <p class="mb-6 text-gray-400 leading-loose">The longest locally owned and operated landscaping company in Central Illinois.</p>
                <div>
          ...
          <div class="w-full lg:w-1/2 lg:px-4">
            <div class="flex flex-wrap lg:mb-4 lg:ml-6">
              <img class="w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-3xl lg:rounded-br-none" src="/a.jpg" alt="">
              <img class="w-full md:w-1/2 lg:w-2/3 h-64 p-2 object-cover rounded-3xl lg:rounded-bl-none" src="/b.jpg" alt="">
            </div>
            <div class="flex flex-wrap lg:mb-4 lg:mr-6">
              <img class="w-full md:w-1/2 lg:w-2/3 h-64 p-2 object-cover rounded-3xl lg:rounded-br-none" src="/back-hoe.jpg" alt="">
              <img class="w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-3xl lg:rounded-bl-none" src="/backhoe-3.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
